...
MongoClient.connect "mongodb:///tmp/mongodb-27017.sock,live.my-card.in:27017,master.my-card.in:27017/mycard?readPreference=nearest&replicaSet=mycard", {server:{auto_reconnect:true,poolSize: 5}}, (err, db)->
